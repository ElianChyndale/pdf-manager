...
- [PDF Manager 后端 API 总入口](/path/to/pdf-manager/doc/core/api/index.md)
- [Rust API README](/path/to/pdf-manager/backend/rust_api/README.md)
- [CURRENT_API_MAP](/path/to/pdf-manager/backend/rust_api/CURRENT_API_MAP.md)
