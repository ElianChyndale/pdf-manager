...
- [translation_flow.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/translation_flow.rs)
...
- [render_flow.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/render_flow.rs)
...
- [ocr_flow/mod.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/ocr_flow/mod.rs)
...
- [lifecycle.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/lifecycle.rs)
...
- [worker_command.rs](/path/to/pdf-manager/backend/rust_api/src/worker_command.rs)
- [worker_command/stage_specs.rs](/path/to/pdf-manager/backend/rust_api/src/worker_command/stage_specs.rs)
- [worker_command/entrypoints.rs](/path/to/pdf-manager/backend/rust_api/src/worker_command/entrypoints.rs)
...
- [worker_process.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/worker_process.rs)
...
- [process_runner.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_runner.rs)
- [process_runner/startup.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_runner/startup.rs)
- [process_runner/execution.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_runner/execution.rs)
- [process_runner/result_support.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_runner/result_support.rs)
- [process_runner/timeout_support.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_runner/timeout_support.rs)
- [process_runner/failure_ai_diagnosis.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_runner/failure_ai_diagnosis.rs)
- [process_runner/io_support.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_runner/io_support.rs)
...
- [runtime_state.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/runtime_state.rs)
...
- [stdout_parser/mod.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/stdout_parser/mod.rs)
...
- [cancel_registry.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/cancel_registry.rs)
- [worker_process.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/worker_process.rs)
...
- Rust 侧 readiness 判断集中在：
  - [stage_contract.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/stage_contract.rs)
  - [process_contract.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_contract.rs)
