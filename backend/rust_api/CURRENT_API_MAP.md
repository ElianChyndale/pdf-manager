...
- 只看 Rust 模块边界：
  [`RUST_API_ARCHITECTURE.md`](/path/to/pdf-manager/backend/rust_api/RUST_API_ARCHITECTURE.md)
- 只看 OCR provider 边界：
...
- 只看渲染参数规范：
  [`RENDER_OPTIONS_CONTRACT.md`](/path/to/pdf-manager/backend/rust_api/RENDER_OPTIONS_CONTRACT.md)
...
- [`src/routes/jobs/mod.rs`](/path/to/pdf-manager/backend/rust_api/src/routes/jobs/mod.rs)
...
- [`backend/scripts/entrypoints/run_provider_case.py`](/path/to/pdf-manager/backend/scripts/entrypoints/run_provider_case.py)
- [`backend/scripts/entrypoints/run_provider_ocr.py`](/path/to/pdf-manager/backend/scripts/entrypoints/run_provider_ocr.py)
- [`backend/scripts/entrypoints/run_normalize_ocr.py`](/path/to/pdf-manager/backend/scripts/entrypoints/run_normalize_ocr.py)
- [`backend/scripts/entrypoints/run_translate_only.py`](/path/to/pdf-manager/backend/scripts/entrypoints/run_translate_only.py)
- [`backend/scripts/entrypoints/run_render_only.py`](/path/to/pdf-manager/backend/scripts/entrypoints/run_render_only.py)
...
- Python 按 provider 分发：
  - [`backend/scripts/services/ocr_provider/provider_pipeline.py`](/path/to/pdf-manager/backend/scripts/services/ocr_provider/provider_pipeline.py)
...
- [`backend/scripts/foundation/shared/stage_specs.py`](/path/to/pdf-manager/backend/scripts/foundation/shared/stage_specs.py)
...
- [`src/routes/jobs/create.rs`](/path/to/pdf-manager/backend/rust_api/src/routes/jobs/create.rs)
...
- [`src/job_runner/lifecycle.rs`](/path/to/pdf-manager/backend/rust_api/src/job_runner/lifecycle.rs)
...
- [`src/job_runner/render_flow.rs`](/path/to/pdf-manager/backend/rust_api/src/job_runner/render_flow.rs)
...
- [`src/app/jobs.rs`](/path/to/pdf-manager/backend/rust_api/src/app/jobs.rs)
...
- `PDF_MANAGER_TRANSLATION_API_KEY`
...
- [`src/job_runner/worker_process.rs`](/path/to/pdf-manager/backend/rust_api/src/job_runner/worker_process.rs)
