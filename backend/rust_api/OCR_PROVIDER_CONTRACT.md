...
- Paddle OCR API 摘要：
  [`src/ocr_provider/paddle/API_SUMMARY.md`](/path/to/pdf-manager/backend/rust_api/src/ocr_provider/paddle/API_SUMMARY.md)
...
- [src/ocr_provider/mod.rs](/path/to/pdf-manager/backend/rust_api/src/ocr_provider/mod.rs)
- [src/ocr_provider/types.rs](/path/to/pdf-manager/backend/rust_api/src/ocr_provider/types.rs)
- [src/ocr_provider/catalog.rs](/path/to/pdf-manager/backend/rust_api/src/ocr_provider/catalog.rs)
- [src/ocr_provider/mineru](/path/to/pdf-manager/backend/rust_api/src/ocr_provider/mineru)
- [src/ocr_provider/paddle](/path/to/pdf-manager/backend/rust_api/src/ocr_provider/paddle)
...
- [catalog.rs](/path/to/pdf-manager/backend/rust_api/src/ocr_provider/catalog.rs)
