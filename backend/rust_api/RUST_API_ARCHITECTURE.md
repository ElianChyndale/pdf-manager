...
- 文档总入口：
  [`README.md`](/path/to/pdf-manager/backend/rust_api/README.md)
- 目录地图：
  [`RUST_API_DIRECTORY_MAP.md`](/path/to/pdf-manager/backend/rust_api/RUST_API_DIRECTORY_MAP.md)
- 当前运行主链：
  [`CURRENT_API_MAP.md`](/path/to/pdf-manager/backend/rust_api/CURRENT_API_MAP.md)
- OCR provider 边界：
  [`OCR_PROVIDER_CONTRACT.md`](/path/to/pdf-manager/backend/rust_api/OCR_PROVIDER_CONTRACT.md)
- stage 运行时契约：
  [`STAGE_EXECUTION_CONTRACT.md`](/path/to/pdf-manager/backend/rust_api/STAGE_EXECUTION_CONTRACT.md)
- Rust 侧 artifact boundary：
  [`doc/core/rust_api/10-Rust 侧 Artifact Boundary.md`](/path/to/pdf-manager/doc/core/rust_api/10-Rust%20%E4%BE%A7%20Artifact%20Boundary.md)
- 外部 API 协议：
  [`API_SPEC.md`](/path/to/pdf-manager/backend/rust_api/API_SPEC.md)
...
- [src/storage_paths.rs](/path/to/pdf-manager/backend/rust_api/src/storage_paths.rs)
  facade；现在已拆成 `constants / job_paths / path_ops / resolvers / registry`
- [src/services/artifacts/mod.rs](/path/to/pdf-manager/backend/rust_api/src/services/artifacts/mod.rs)
  artifact facade；现在已拆成 `registry / bundle / response`
- [src/routes/jobs/download.rs](/path/to/pdf-manager/backend/rust_api/src/routes/jobs/download.rs)
  负责下载类 HTTP adapter
...
- [src/app/mod.rs](/path/to/pdf-manager/backend/rust_api/src/app/mod.rs)
- [src/app/state.rs](/path/to/pdf-manager/backend/rust_api/src/app/state.rs)
- [src/app/router.rs](/path/to/pdf-manager/backend/rust_api/src/app/router.rs)
- [src/app/server.rs](/path/to/pdf-manager/backend/rust_api/src/app/server.rs)
...
- [src/routes](/path/to/pdf-manager/backend/rust_api/src/routes)
...
- [src/services/jobs/facade.rs](/path/to/pdf-manager/backend/rust_api/src/services/jobs/facade.rs)
...
- [src/services](/path/to/pdf-manager/backend/rust_api/src/services)
...
- [src/services/jobs/facade.rs](/path/to/pdf-manager/backend/rust_api/src/services/jobs/facade.rs)
- [src/services/glossary_api.rs](/path/to/pdf-manager/backend/rust_api/src/services/glossary_api.rs)
- [src/services/upload_api.rs](/path/to/pdf-manager/backend/rust_api/src/services/upload_api.rs)
...
- [src/services/job_snapshot_factory.rs](/path/to/pdf-manager/backend/rust_api/src/services/job_snapshot_factory.rs)
  负责 job snapshot / command 组装
- [src/services/job_launcher.rs](/path/to/pdf-manager/backend/rust_api/src/services/job_launcher.rs)
  负责 job 持久化与执行启动
- [src/services/runtime_gateway.rs](/path/to/pdf-manager/backend/rust_api/src/services/runtime_gateway.rs)
  负责 services 侧 runtime 能力收口
- [src/services/jobs](/path/to/pdf-manager/backend/rust_api/src/services/jobs)
  负责 jobs 相关业务
...
- [src/services/jobs/facade.rs](/path/to/pdf-manager/backend/rust_api/src/services/jobs/facade.rs)
- [src/services/jobs/facade/command](/path/to/pdf-manager/backend/rust_api/src/services/jobs/facade/command)
- [src/services/jobs/facade/query](/path/to/pdf-manager/backend/rust_api/src/services/jobs/facade/query)
...
- [src/services/jobs/creation](/path/to/pdf-manager/backend/rust_api/src/services/jobs/creation)
...
- [src/services/jobs/presentation](/path/to/pdf-manager/backend/rust_api/src/services/jobs/presentation)
...
- [src/job_runner](/path/to/pdf-manager/backend/rust_api/src/job_runner)
...
- [src/worker_command](/path/to/pdf-manager/backend/rust_api/src/worker_command)
...
- `command_builder.rs`
  只做命令行构建细节
- [src/worker_command.rs](/path/to/pdf-manager/backend/rust_api/src/worker_command.rs)
  只保留对外 `build_*` facade
...
- [src/job_runner/process_runner.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_runner.rs)
- [src/job_runner/process_runner/startup.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_runner/startup.rs)
- [src/job_runner/process_runner/execution.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_runner/execution.rs)
- [src/job_runner/process_runner/completion.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_runner/completion.rs)
- [src/job_runner/process_runner/timeout_support.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_runner/timeout_support.rs)
- [src/job_runner/process_runner/failure_ai_diagnosis.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_runner/failure_ai_diagnosis.rs)
- [src/job_runner/process_runner/io_support.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/process_runner/io_support.rs)
...
- [src/job_runner/translation_flow.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/translation_flow.rs)
- [src/job_runner/translation_flow_child.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/translation_flow_child.rs)
- [src/job_runner/translation_flow_stage.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/translation_flow_stage.rs)
- [src/job_runner/translation_flow_support.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/translation_flow_support.rs)
...
- [src/job_runner/ocr_flow/mod.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/ocr_flow/mod.rs)
- [src/job_runner/ocr_flow/support.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/ocr_flow/support.rs)
...
- [src/job_runner/stdout_parser/mod.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/stdout_parser/mod.rs)
- [src/job_runner/stdout_parser/labels.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/stdout_parser/labels.rs)
- [src/job_runner/stdout_parser/state.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/stdout_parser/state.rs)
- [src/job_runner/stdout_parser/stage_rules.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/stdout_parser/stage_rules.rs)
- [src/job_runner/stdout_parser/artifact_rules.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/stdout_parser/artifact_rules.rs)
- [src/job_runner/stdout_parser/failure.rs](/path/to/pdf-manager/backend/rust_api/src/job_runner/stdout_parser/failure.rs)
...
- [src/ocr_provider](/path/to/pdf-manager/backend/rust_api/src/ocr_provider)
