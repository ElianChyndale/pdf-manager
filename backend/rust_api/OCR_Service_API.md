...
- 这是一份 OCR-only 专项说明，正式 API 总入口先看 [PDF Manager 后端 API 总入口](/path/to/pdf-manager/doc/core/api/index.md)，运行主链看 [CURRENT_API_MAP](/path/to/pdf-manager/backend/rust_api/CURRENT_API_MAP.md)
