...
_TEXT_ROLE_BY_SUBTYPE = {
    ...
    "caption": PaddleTextRoleRule(
        layout_role="caption",
        structure_role="caption",
        translate=True,
        translate_reason="provider_caption_whitelist:caption",
    ),
    "image_caption": PaddleTextRoleRule(
        layout_role="caption",
        structure_role="image_caption",
        translate=True,
        translate_reason="provider_caption_whitelist:image_caption",
    ),
    ...
    "code_caption": PaddleTextRoleRule(
        layout_role="caption",
        structure_role="code_caption",
        translate=True,
        translate_reason="provider_caption_whitelist:code_caption",
    ),
