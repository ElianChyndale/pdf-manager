...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run and verify a PDF Manager golden OCR->translation->render flow.",
    )
    ...
    parser.add_argument("--translation-credential-ref", type=str, default="env:PDF_MANAGER_TRANSLATION_API_KEY")
