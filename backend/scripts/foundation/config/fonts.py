...
DEFAULT_FONT_PATH = Path(
    os.environ.get("PDF_MANAGER_FONT_PATH", "").strip()
    or "/usr/share/fonts/truetype/droid/DroidSansFallbackFull.ttf"
)
TITLE_BOLD_FONT_PATH = Path(
    os.environ.get("PDF_MANAGER_TITLE_BOLD_FONT_PATH", "").strip()
    or str(BACKEND_FONTS_DIR / "SourceHanSerifSC-Bold.otf")
)
DEFAULT_FONT_SIZE = 11.4
MIN_FONT_SIZE = 8.5
TYPST_DEFAULT_FONT_FAMILY = os.environ.get("PDF_MANAGER_TYPST_FONT_FAMILY", "").strip() or "Source Han Serif SC"
