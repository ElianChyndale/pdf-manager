...
它不是 PDF Manager 主流程协议文档，而是“如果要接模型服务，先看什么”的参考目录。

## 适用范围

- 想看模型服务接入参考时看这里
- 想看 PDF Manager 自己的翻译链路，请优先看 [Python 文档](../../core/python/README.md) 和 [Rust API 文档](../../core/rust_api/README.md)

## DeepSeek

建议优先阅读：

1. [PDF Manager 接入建议](./DeepSeek/Retain_接入建议.md)
